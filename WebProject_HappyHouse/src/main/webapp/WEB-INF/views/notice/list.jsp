...
<script type="text/javascript">
	...
	function pageMove(pg) {
		...
		document.getElementById("searchform").action = "${root}/api/board/notice.do";
					...
					<table class="table table-borderless">
						<tr>
							<td align="right"><button type="button"
									class="btn btn-primary" onclick="javascript:movewrite();">공지
									작성</button></td>
						</tr>
					...
					<c:forEach var="notice" items="${notices}">
						<table class="table table-active">
							<tbody>
								<tr class="table-info">
									<td width="400px">제목 : <a
										href="${root}/api/board/detailnotice.do/${notice.articleno}">${notice.subject}</a></td>
