...
<div>
    <div class="additional">
        <div class="user-card">
            ...
            <v-btn @click="delparent(child.userNo)">삭제</v-btn>
        ...
        <div class="more-info">
            ...
            <div class="stats">
                <div class="stat">
                    ...
                    <i class="fa fa-trophy icon-item"></i>
                    <div class="value">{{child.korean}}%</div>
                </div>
                <div class="stat">
                    <div class="title">낱말연습</div>
                    <i class="fa fa-gamepad icon-item"></i>
                    <div class="value">{{child.wordtest}}%</div>
                </div>
                <div class="stat">
                    <div class="title">받아쓰기</div>
                    <i class="fa fa-users icon-item"></i>
                    <div class="value">{{child.dictation}}%</div>
                </div>
            </div>
        </div>
    </div>
