...
#     user_no = models.ForeignKey('User', primary_key=True, null=False, on_delete=models.CASCADE) # 회원 번호 fk면서pk?
#     carb = models.IntegerField(null=False) # 탄수화물
#     protein = models.IntegerField(null=False) # 단백질
#     fat = models.IntegerField(null=False) # 지방
# class Complist(models.Model):
#     user_no = models.ForeignKey('User', null=False, db_column='user_no', on_delete=models.CASCADE) # 회원 번호
#     food_no = models.ForeignKey('Food', null=False, db_column='food_no', on_delete=models.CASCADE) # 음식 번호
#     class Meta:
#         managed = False
#         db_table = 'complist'
...
#     nick_name = models.CharField(max_length=20, null=False)            # 닉네임
#     gender = models.CharField(max_length=1, null=False, default='m')   # 성별 m-남|f-여 
#     address = models.CharField(max_length=150, null=False)             # 주소
...
#     plan_carb = models.IntegerField(null=True, blank=True)             # 다이어트 계획 탄수화물
#     plan_protein = models.IntegerField(null=True, blank=True)          # 다이어트 계획 단백질
#     plan_fat = models.IntegerField(null=True, blank=True)              # 다이어트 계획 지방
#     class Meta:
#         db_table = 'user'
...
#     manufacturer = models.CharField(max_length=50, null=True, blank=True)                                        # 제조사(가공식품인 경우)
#     store_no = models.ForeignKey('Store', db_column='store_no', null=True, blank=True, on_delete=models.CASCADE) # 식당번호(식당 메뉴인 경우)
#     group_no = models.ForeignKey('self', db_column='food_no', null=True, blank=True, on_delete=models.CASCADE)   # 음식그룹번호(식당메뉴나 가공식품의 경우, 일반음식의 음식번호로 그룹핑됨)
#     class Meta:
#         db_table = 'food'
