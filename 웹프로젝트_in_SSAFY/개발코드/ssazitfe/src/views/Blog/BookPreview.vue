        ...
        <div class="demo-block bg-light pt-3 pb-3 overflow-hidden">
              ...
              <div class="flip-book html-book stf__wrapper --landscape" id="htmlBookExample" style="min-width: 350px; min-height: 467px; width: 100%; max-width: 1400px; display: block; padding-bottom: 66.6364%;">
                <div class="stf__block">
                    ...
                    <div class="page-content">
                      <div class="page-text"><h1>{{bookTitle}}</h1></div>
                    </div>

                  </div>
                  <div class="page stf__item">
                    <div class="page-content">
                      <div class="page-text" v-html="bookIndex"></div>
                    </div>
                  </div>
                  ...
                  <div class="page stf__item">
                    <div class="page-content" >
                      <div class="page-text" v-html="bookReference"></div>
                    </div> 
                  </div>
                  <div class="page stf__item">
                  </div>
          ...
          <div class="container">
            <div class="text-center mt-3 mb-2">
              <button type="button" class="btn-book-prev"></button>
              <!-- <span class="page-count"></span>  <span class="page-total"></span> -->
              <button type="button" class="btn-book-next"></button>
            </div>
          </div>
...
export default {
  ...
  props:['editorData', 'bookTitle', 'bookIndex','bookReference'],
  methods: {
    bookAnimation(){ 
     !(function (t) {
        var e = {};
